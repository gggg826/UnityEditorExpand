...
{
    const string RuntimeNameSpace = "namespace ACE";
    const string EditorNameSpace = "namespace EditorTool";
    private static void OnWillCreateAsset(string path)
    {
        string AuthorName = "Bing Lau";
        ...
        if (path.EndsWith(".cs"))
        {
            ...
            for (i = 0; i < lines.Length; i++)
            {
                ...
                string strNameSpace = path.Contains("/Editor/") ? EditorNameSpace : RuntimeNameSpace;
                strNote1.Append($"{strNameSpace}\r\n");
                strNote1.Append("{\r\n");
                break;
            }
